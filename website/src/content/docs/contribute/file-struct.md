---
title: wrapper Project Structure Guide
description: A detailed guide to understanding wrapper's codebase organization
head:
  - tag: title
    content: wrapper Project Structure Guide | wrapper
---

# wrapper Project Structure Guide
...
### `testsuite/` - wrapper's testsuite written in Python

- Automatically tests wrapper's functionality.
