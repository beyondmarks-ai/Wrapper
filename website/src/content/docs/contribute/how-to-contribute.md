...
head:
  - tag: title
    content: How to Contribute | wrapper
---

# Contributing to wrapper

Welcome to **wrapper**! This guide will help you get started contributing to the project, whether you're fixing bugs, building features, or just sharing ideas.
...
3. Test it by editing your `~/.config/wrapper/config/config.toml`
...
- Full view of wrapper (Including sidebar, file previewer, process panel, metadata panel, and clipboard panel )
...
- Full view of wrapper (Including sidebar, file previewer, process panel, metadata panel, and clipboard panel)
  ...
  ![Full view of wrapper](../../../assets/contributing/theme-example/1.png)
...
2. Open a discussion at: [https://github.com/beyondmarks-ai/Wrapper/discussions](https://github.com/beyondmarks-ai/Wrapper/discussions)
...
Thank you for contributing to wrapper! We appreciate every issue, pull request, and idea. Your help makes this project better for everyone.
