---
title: Enable Plugin
description: How to enable and configure wrapper plugins
head:
  - tag: title
    content: Enable Plugins | wrapper
---

Plugins extend wrapper's functionality by integrating with external tools. This guide shows you how to enable and configure plugins.
...
2. **Restart wrapper** - Changes require restarting the application
