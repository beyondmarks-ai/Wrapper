...
func (m *model) introduceModalRender() string {
	title := common.SidebarTitleStyle.Render(" Thanks for using wrapper!!") +
	...
	vimUserWarn := common.ProcessErrorStyle.Render("  ** Very importantly ** If you are a Vim/Nvim user, go to:\n" +
		"  https://wrapper.dev/configure/custom-hotkeys/ to change your hotkey settings!")
	...
	subFour := common.SidebarTitleStyle.Render("  (4)") +
		common.ModalStyle.Render(" Thank you again for using wrapper.\n"+
			"      If you have any questions, please feel free to ask at:\n"+
			"      https://github.com/beyondmarks-ai/Wrapper\n"+
...
func (m *model) everythingModalRender() string {
	return m.everythingModal.Render()
}
