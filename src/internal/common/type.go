...
// RevealPathAction opens a directory or reveals a file in the current panel.
type RevealPathAction struct {
	Path  string
	IsDir bool
}

func (r RevealPathAction) String() string {
	return "RevealPathAction for " + r.Path
}
