...
func getData() []hotkeydata { //nolint: funlen // This should be self contained
	data := []hotkeydata{
		...
		},
		{
			...
			description:    "Quit typing, modal or wrapper",
			hotkeyWorkType: globalType,
		},
		{
			hotkey:         common.Hotkeys.CdQuit,
			description:    "Quit wrapper and change directory to current folder",
			hotkeyWorkType: globalType,
		},
		{
		...
		{
			hotkey:         common.Hotkeys.OpenWRAPPrompt,
			description:    "Open WRAP prompt",
			hotkeyWorkType: globalType,
		},
		{
		...
		{
			hotkey:         common.Hotkeys.OpenEverything,
			description:    "Search all indexed files with Everything (Windows)",
			hotkeyWorkType: globalType,
		},
		{
			hotkey:         common.Hotkeys.TransferItems,
			description:    "Send selected files or folders to another PC",
			hotkeyWorkType: globalType,
		},
		{
