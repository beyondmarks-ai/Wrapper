...
// initialConfig load and handle all configuration files (wrap config,Hotkeys
...
func initialConfig(firstPanelPaths []string) (toggleDotFile bool, //nolint: nonamedreturns // See above
	...
	// TODO : This could be improved if we want to make wrapper more resilient to errors
	...
	if err != nil {
		utils.PrintfAndExitf("Error while opening wrapper.log file : %v", err)
	}
