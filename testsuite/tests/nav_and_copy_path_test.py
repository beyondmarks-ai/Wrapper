...
class NavCopyPathTest_Disabled(GenericTestImpl):
    ...
    def test_execute(self) -> None:
        ...
        self.env.wrap_mgr.send_special_input(keys.KEY_UP)
        time.sleep(tconst.KEY_DELAY)
        #   dir1 
        # > file1
        #   file2
