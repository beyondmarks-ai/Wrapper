...
class EmptyPanelTest(GenericTestImpl):
    """
    Validate that wrap doesn't crashes when we try to
    ...
    def __init__(self, test_env : Environment):
        super().__init__(
            ...
            # Makes sure wrap doesn't crashes
            validate_wrap_running=True
        )
    ...
    def test_execute(self) -> None:
        ...
        # Intentionally not closing wrap to ensure it remains running,
        # which is verified by the validate_wrap_running flag which is set
